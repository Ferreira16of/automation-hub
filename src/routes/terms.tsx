...
export const Route = createFileRoute("/terms")({
  head: () => ({ meta: [{ title: "Termos e Condições — Luma Hub" }] }),
  component: Page,
});
  ...
  return (
    <AppShell>
      <article className="mx-auto max-w-3xl px-4 py-12">
        ...
        <p>Ao usar o Luma Hub, você concorda com estes termos.</p>
        ...
        <p>O Luma Hub é um orquestrador. Você é responsável por respeitar os termos das APIs que conectar.</p>
